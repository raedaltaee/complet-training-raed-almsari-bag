...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="container mx-auto p-4 md:p-8">
        ...
        <footer class="text-center mt-24 border-t pt-8 border-gray-200">
            ...
            <p class="text-gray-500">ماجستير هندسة اتصالات</p>
    ...
    <script>
        ...
        new Chart(document.getElementById('toolsChart'), {
            type: 'bar',
            data: {
                labels: ['المحاكاة (PhET)', ['الاختبارات التفاعلية', '(Kahoot, Slido)'], ['العصف الذهني', '(Miro, Mural)'], 'العروض التقديمية'],
                datasets: [{
                    label: 'مستوى التفاعل',
                    data: [90, 85, 80, 60],
        ...
        new Chart(document.getElementById('futureTechChart'), {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [8, 9, 10, 7],
                    fill: true,
                    backgroundColor: 'rgba(62, 193, 243, 0.2)',
                    borderColor: 'rgb(62, 193, 243)',
...
<body class="bg-gray-50 text-gray-800">
  ...
  <p>ديو# complet-training-raed-almsari-bag
